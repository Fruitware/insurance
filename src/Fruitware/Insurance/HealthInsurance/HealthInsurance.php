...
class HealthInsurance extends InsuranceAbstract
{
     ...
     * @param  DateTime  $to  End date of period
     ...
     * @param  bool  $is_covid  Covid Insurance
     ...
     */
    public function calculate(array $persons, $alias, $amount, $from, $to, $is_work, $is_sport, $is_skiing, $is_covid)
    {
     ...
     * @param  bool  $is_sport  Participate in sport competitions during insurance
     * @param  bool  $is_skiing  Skiing during insurance
     * @param  bool  $is_covid  Covid insurance included
     *
     * @return float Insurance price for one person
     * @throw Exception free-text exceptions, doesnt specify type of error, just it occurrence
     */
    public function calculateSinglePerson($age, $alias, $amount, $days, $per_day, $is_work, $is_sport, $is_skiing, $is_covid)
    {
